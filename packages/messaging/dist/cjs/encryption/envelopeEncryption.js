...
var envelopeEncryption_exports = {};
__export(envelopeEncryption_exports, {
  EnvelopeEncryption: () => EnvelopeEncryption
});
module.exports = __toCommonJS(envelopeEncryption_exports);
var import_seal = require("@mysten/seal");
var import_utils = require("@mysten/sui/utils");
var import_logging = require("../logging/index.js");
var import_webCryptoPrimitives = require("./webCryptoPrimitives.js");
var import_transactions = require("@mysten/sui/transactions");
var import_sessionKeyManager = require("./sessionKeyManager.js");
...
class EnvelopeEncryption {
  constructor(config) {
    ...
    __privateSet(this, _encryptionPrimitives, config.encryptionPrimitives ?? import_webCryptoPrimitives.WebCryptoPrimitives.getInstance());
    __privateSet(this, _sessionKeyManager, new import_sessionKeyManager.SessionKeyManager(
      config.sessionKey,
  ...
  async generateEncryptedChannelDEK({
    ...
    const logger = (0, import_logging.getLogger)(import_logging.LOG_CATEGORIES.ENCRYPTION);
    logger.debug("Generating encrypted channel DEK", { channelId });
    if (!(0, import_utils.isValidSuiObjectId)(channelId)) {
    ...
    const sealPolicyBytes = (0, import_utils.fromHex)(channelId);
    const id = (0, import_utils.toHex)(new Uint8Array([...sealPolicyBytes, ...nonce]));
  ...
  async decryptChannelDEK({
    ...
    if (!(0, import_utils.isValidSuiObjectId)(memberCapId)) {
      throw new Error("The memberCapId provided is not a valid Sui Object ID");
    }
    const channelIdBytes = import_seal.EncryptedObject.parse(encryptedKey.encryptedBytes).id;
    ...
    tx.moveCall({
      ...
      arguments: [
        ...
        tx.pure.vector("u8", (0, import_utils.fromHex)(channelIdBytes)),
        // Channel Object
        tx.object(channelId),
        // Member Cap Object
